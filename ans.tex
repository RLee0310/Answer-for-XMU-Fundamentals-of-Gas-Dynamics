...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsc{Solutions to End-of-Chapter Problems}}  % 页眉左侧
...
If you need the \LaTeX\ source code, please visit this project: \mylink{https://www.keepresearch.com/editor/RebeccaLee050310/XMUAEROGasDynamicsAnswer}{Answer}.  

You can also contact me via email: \mylink{mailto:1137832391@qq.com}{1137832391@qq.com}.
...
$\mu_1=\cot^{-1}(M_1^2-1)^{\frac{1}{2}}$, $\nu_1=\left(\dfrac{\gamma+1}{\gamma-1}\right)^{\frac{1}{2}}\tan^{-1}\left[\dfrac{\gamma-1}{\gamma+1}(M_1^2-1)\right]-\tan^{-1}(M_1^2-1)^{\frac{1}{2}}$.
